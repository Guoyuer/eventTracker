...
class DatabaseAtV7 extends GeneratedDatabase {
  ...
  late final Index recordsActivityId = Index(
    'records_activity_id',
    'CREATE INDEX records_activity_id ON records (activity_id)',
  );
  late final Index recordsOneActivePerActivity = Index(
    'records_one_active_per_activity',
    'CREATE UNIQUE INDEX records_one_active_per_activity ON records (activity_id) WHERE end_time IS NULL',
  );
  @override
